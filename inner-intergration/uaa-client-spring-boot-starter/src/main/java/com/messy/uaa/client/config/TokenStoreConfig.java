package com.messy.uaa.client.config;

import com.messy.uaa.client.token.RedisTemplateTokenStore;
import com.messy.uaa.client.token.ResJwtAccessTokenConverter;
