package com.messy.service;

import com.alibaba.fastjson.JSONObject;
import com.messy.common.auth.details.DefaultClientDetails;
...
public class RedisClientDetailsService extends JdbcClientDetailsService {
	...
	private static class ClientDetailsRowMapper implements RowMapper<ClientDetails> {
		private com.messy.json.JsonMapper mapper = createJsonMapper();
	 ...
	 * @return
	 */
	private static com.messy.json.JsonMapper createJsonMapper() {
		if (ClassUtils.isPresent("org.codehaus.jackson.map.ObjectMapper", null)) {
			return new com.messy.json.JacksonMapper();
		}
		else if (ClassUtils.isPresent("com.fasterxml.jackson.databind.ObjectMapper", null)) {
			return new com.messy.json.Jackson2Mapper();
		}
		return new com.messy.json.NotSupportedJsonMapper();
	}
